    ...
    sidebarPanel(
      ...
      conditionalPanel(condition="input.tabs1=='Cross-sectionnal'",
                ...
                #           checkboxInput("btrespcs", label = 'Back transform the data', value = TRUE),
                       ...
                       div(align = "center", h4("Image export"),
                           ...
                           textInput3(inputId="cscex", label="Size", value = 1),
                           textInput3(inputId="cscexpt", label="Point size", value = 1.2)),
      ...
      conditionalPanel(condition="input.tabs1=='Survival'",
                       ...
                       textInput3(inputId="kmshift", label="Shifting factor", value = 0.1), 
                           textInput3(inputId="kmlwd", label="Line width", value = 1.5)),
                       br(),
                       div(align = "center", h4("Image export"),
                           textInput3(inputId="kmwidth", label="Width", value = 5),
                           textInput3(inputId="kmheight", label="Height", value = 4),
                           textInput3(inputId="kmcex", label="Size", value = 1),
                           textInput3(inputId="kmcexpt", label="Point size", value = 1.2)),
      ...
      tabsetPanel(
        ...
        tabPanel("Longitudinal",
                 bsCollapse(id = "collapseLG", open = c("Type II ANOVA","Pairwise comparisons"),multiple=TRUE,
                            bsCollapsePanel("Type II ANOVA", shiny::tableOutput("modelLGeffect"),style = "info"),
                            bsCollapsePanel("Pairwise comparisons", 
                                            uiOutput("grplgvar"),
                                            radioButtons("radiolgadj",label=NULL, choices=c('No',"Holm","Bonferroni adjustement"),selected='No',inline = TRUE),
        ...
        tabPanel("Cross-sectionnal",
                 bsCollapse(id = "collapseCS", open = c("Distribution","Pairwise comparisons"),multiple=TRUE,
                            ...
                            bsCollapsePanel("Pairwise comparisons",shiny::tableOutput("modCSeffect"),uiOutput("grpcsvar"),
                                            radioButtons("radiocsadj",label=NULL, choices=c('No',"Holm","Bonferroni adjustement"),selected='No',inline = TRUE),
                            ...
                            bsCollapsePanel("Model information",
                                            shiny::tableOutput("modCS"),verbatimTextOutput("modCSwei"),
                                            verbatimTextOutput("outCS"), style = "info"),
                            bsCollapsePanel("Data points selection",shiny::tableOutput("sumCS"),
        ...
        tabPanel("Survival",
                 bsCollapse(id = "collapseKM", open = c("Kaplan Meier","Cox regression"),multiple=TRUE,
                            ...
                            bsCollapsePanel("Cox regression",
                                            ...
                                            radioButtons("radiokmadj",label=NULL, choices=c('No',"Holm","Bonferroni adjustement"),selected='No',inline = TRUE),
                                            tableOutput("modKM"),
                                            DT:::dataTableOutput("hrKM"), style = "info"),
                            bsCollapsePanel("Censoring information", shiny::tableOutput("sumKM"),
